  ...
  if (contracts.length === 0) {
    return (
      <OnboardingEmptyState
        ...
        title="Aucun contrat"
        description="Ajoutez un employé depuis la page Équipe pour créer son contrat de travail."
        actions={
          <AccessibleButton colorPalette="brand" asChild accessibleLabel="Aller à la page Équipe">
            <RouterLink to="/equipe">Aller à Équipe</RouterLink>
          </AccessibleButton>
        }
      />
    )
